...
for num_components in num_components_list:
    ...
    model_param_grid = {
      'model__nu': [0.1, 0.3, 0.5, 0.7, 0.9],  # Try different values of nu
      'model__C': [0.1, 1.0, 10.0, 100.0],    # Try different values of C
      'model__kernel': ['linear', 'poly', 'rbf', 'sigmoid'],  # Try different kernels
    }
